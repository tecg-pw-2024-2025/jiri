    ...
    <form action="{{ route('projects.update',$project) }}"
        ...
        <div class="flex flex-col gap-2">
            ...
            <textarea id="description"
                      ...
                      autocorrect="off"
                      spellcheck="false"
                      class="border border-grey-700 focus:invalid:border-pink-500 invalid:text-pink-600 rounded-md p-2">{{ old('description', $project) }}</textarea>
        </div>
        <x-form-submission-button class="bg-blue-500">{!! __('update this project') !!}</x-form-submission-button>
    </form>
</x-app-layout>
