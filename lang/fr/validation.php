...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Ici, tu peux spécifier des messages de validation personnalisés pour les attributs
    | en utilisant la convention "nom-attribut.règle" pour nommer les lignes. Cela te permet
    ...
    */
    ...
    | au lieu de "email". Cela nous aide simplement à rendre nos messages plus expressifs.
    |
    */

    'attributes' => [
        'name' => 'nom',
        'starting_at' => 'commençant à',
